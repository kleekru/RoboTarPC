...
public class XMLChordLoader {
    ...
    try {
            ...
            Document doc = docBuilder.parse (new File(RoboTarChordsPage.ROOT_DIR + "RoboTarIOIOforPCConsole/src/data/chordlist.xml"));

            // normalize text representation
            doc.getDocumentElement ().normalize ();
            System.out.println ("Root element of the doc is " + doc.getDocumentElement().getNodeName());
            
            NodeList listOfChords = doc.getElementsByTagName("chord");
            ...
            for (int q=0; q<listOfChords.getLength(); q++) {
            	...
            	if (node.getNodeType()== Node.ELEMENT_NODE){
            		...
            		System.out.println("Chord Name: " + getValue("chordname", element));
            		System.out.println("6th String Address: " + getValue("fingeraddress6", element));
